...
wtrapa<-read.table('~/Google_Drive/Lab/Data_Analysis/Heatmaps/MRP7-10/MRP7/heatmap')
conrapa<-read.table('~/Google_Drive/Lab/Data_Analysis/Heatmaps/MRP7-10/MRP10/heatmap')
